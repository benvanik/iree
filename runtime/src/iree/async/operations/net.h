...
//   accept_op.base.opcode = IREE_ASYNC_OPCODE_SOCKET_ACCEPT;
//   accept_op.base.flags = IREE_ASYNC_OPERATION_FLAG_MULTISHOT;
//   accept_op.base.callback = on_accept;
...
// Returns the total allocation size for a recv operation with |buffer_count|
// scatter-gather entries.
static inline iree_host_size_t iree_async_socket_recv_operation_size(
    iree_host_size_t buffer_count) {
  return sizeof(iree_async_socket_recv_operation_t) +
         buffer_count * sizeof(iree_async_span_t);
}
...
// Returns the total allocation size for a send operation with |buffer_count|
// scatter-gather entries.
static inline iree_host_size_t iree_async_socket_send_operation_size(
    iree_host_size_t buffer_count) {
  return sizeof(iree_async_socket_send_operation_t) +
         buffer_count * sizeof(iree_async_span_t);
}
...
// Returns the total allocation size for a sendto operation with |buffer_count|
// scatter-gather entries.
static inline iree_host_size_t iree_async_socket_sendto_operation_size(
    iree_host_size_t buffer_count) {
  return sizeof(iree_async_socket_sendto_operation_t) +
         buffer_count * sizeof(iree_async_span_t);
}
...
// Returns the total allocation size for a recvfrom operation with
// |buffer_count| scatter-gather entries.
static inline iree_host_size_t iree_async_socket_recvfrom_operation_size(
    iree_host_size_t buffer_count) {
  return sizeof(iree_async_socket_recvfrom_operation_t) +
         buffer_count * sizeof(iree_async_span_t);
}

...
//
//   iree_async_slab_allocate() -- NUMA-aware allocation with optional huge
...
// Configuration for iree_async_slab_allocate().
...
iree_status_t iree_async_slab_allocate(const iree_async_slab_options_t* options,
                                       iree_allocator_t allocator,

...
typedef struct iree_async_linux_signal_state_t {
  ...
  // Original signal mask saved before any modifications, restored on teardown.
...
// Tears down all signal handling unconditionally.
//
...
void iree_async_linux_signal_teardown(iree_async_linux_signal_state_t* state);

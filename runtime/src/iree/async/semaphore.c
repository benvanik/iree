...
//===----------------------------------------------------------------------===//
// Software semaphore implementation
//===----------------------------------------------------------------------===//
...
// Returns the total allocation size for a software semaphore with the given
// frontier capacity.
static inline iree_host_size_t iree_async_semaphore_software_size(
    uint8_t frontier_capacity) {
  // Trailing storage: iree_async_frontier_t header + entries[frontier_capacity]
  return sizeof(iree_async_semaphore_software_t) +
         iree_async_frontier_size(frontier_capacity);
}

//===----------------------------------------------------------------------===//
// Software semaphore vtable implementation
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_create_software
//===----------------------------------------------------------------------===//
...
IREE_API_EXPORT iree_status_t iree_async_semaphore_create_software(
  ...
  *out_semaphore = NULL;
  ...
  iree_host_size_t total_size =
      iree_async_semaphore_software_size(frontier_capacity);
  iree_async_semaphore_software_t* semaphore = NULL;
  IREE_RETURN_IF_ERROR(
      iree_allocator_malloc(allocator, total_size, (void**)&semaphore));
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_destroy
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_query
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_signal_impl
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_query_frontier
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_fail
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_acquire_timepoint
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_cancel_timepoint
//===----------------------------------------------------------------------===//
...
//===----------------------------------------------------------------------===//
// iree_async_semaphore_software_export_primitive
//===----------------------------------------------------------------------===//

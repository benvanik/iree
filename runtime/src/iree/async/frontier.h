...
//   - Slab: via iree_async_frontier_size() for dynamic construction.
...
// Returns the total byte size needed to store a frontier with |entry_count|
// entries. Use this for slab or heap allocation:
//
//   iree_async_frontier_t* f = NULL;
//   IREE_RETURN_IF_ERROR(
//       iree_allocator_malloc(allocator, iree_async_frontier_size(3),
//                             (void**)&f));
...
static inline iree_host_size_t iree_async_frontier_size(

...
#define IREE_HAL_AMDGPU_DEVICE_BUFFER_FILL_KERNARG_ALIGNMENT 8
#define IREE_HAL_AMDGPU_DEVICE_BUFFER_COPY_KERNARG_SIZE (3 * sizeof(void*))
#define IREE_HAL_AMDGPU_DEVICE_BUFFER_COPY_KERNARG_ALIGNMENT 8

// State used when scheduling transfer commands.
typedef struct iree_hal_amdgpu_device_buffer_transfer_state_t {
...
} iree_hal_amdgpu_device_buffer_transfer_state_t;

...
#ifndef IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_QUEUE_H_
#define IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_QUEUE_H_
...
typedef struct iree_hsa_queue_s {
  ...
  IREE_CL_GLOBAL IREE_CL_ALIGNAS(64) void* base_address;
...
// an iree_hsa_queue_t.
typedef struct IREE_CL_ALIGNAS(64) iree_amd_queue_s {
...
typedef struct iree_hsa_kernel_dispatch_packet_s {
  ...
  IREE_CL_GLOBAL IREE_CL_ALIGNAS(16) void* kernarg_address;
...
#endif  // IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_QUEUE_H_

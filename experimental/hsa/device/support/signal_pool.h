...
#ifndef IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_POOL_H_
#define IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_POOL_H_
...
typedef iree_amdgpu_ringbuffer_uint64_t iree_amdgpu_signal_pool_t;

// Returns the total size in bytes of the signal pool with the given
// power-of-two capacity.
#define iree_amdgpu_signal_pool_calculate_size(capacity) \
  iree_amdgpu_ringbuffer_uint64_calculate_size(capacity)
...
#endif  // IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_POOL_H_

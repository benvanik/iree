...
#ifndef IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_H_
#define IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_H_

#include "experimental/hsa/device/support/opencl.h"

typedef struct IREE_CL_ALIGNAS(64) iree_amd_queue_s iree_amd_queue_t;
...
typedef struct IREE_CL_ALIGNAS(64) iree_amd_signal_s {
  ...
  uint32_t event_id;
  uint32_t reserved1;
  iree_amdgpu_tick_t start_ts;
  iree_amdgpu_tick_t end_ts;
  IREE_CL_GLOBAL iree_amd_queue_t* queue_ptr;
...
static IREE_CL_ATTRIBUTE_ALWAYS_INLINE inline bool
...
#endif  // IREE_HAL_DRIVERS_HSA_DEVICE_SUPPORT_SIGNAL_H_

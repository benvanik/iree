...
#ifndef IREE_HAL_DRIVERS_HSA_DEVICE_ALLOCATOR_H_
#define IREE_HAL_DRIVERS_HSA_DEVICE_ALLOCATOR_H_
...
//     grow
//     trim
// iree_amdgpu_pool_grow(pool, block_id, [allocation], signal)
//   iree_amdgpu_pool_allocation_t
//     allocation_size
//     allocation_offset
//     min_alignment
//     handle*
...
//   signal completion
// iree_amdgpu_pool_trim(pool, block_id, [handle], signal)
//   perform deallocation, clear handle
//   trim block
//   signal completion
//
// iree_amdgpu_ringbuffer_pool_t
// iree_amdgpu_ringbuffer_pool_block_t
//
// iree_amdgpu_suballocator_pool_t
// iree_amdgpu_suballocator_pool_block_t
//
// iree_amdgpu_dedicated_pool_t
//   blocks[max]
// iree_amdgpu_dedicated_pool_block_t
...
// return: iree_amdgpu_allocation_handle_t* handle;
...
//
typedef struct iree_amdgpu_allocator_t {
  // host agent
  // device->host queue
  // local pools
  int reserved;
} iree_amdgpu_allocator_t;
...
#endif  // IREE_HAL_DRIVERS_HSA_DEVICE_ALLOCATOR_H_
